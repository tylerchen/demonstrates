 ...
 */
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements
		Ordered {
	...
	public void setViewClass(Class<?> viewClass) {
		if (viewClass == null
				|| !requiredViewClass().isAssignableFrom(viewClass)) {
			throw new IllegalArgumentException("Given view class ["
	...
	protected View createView(String viewName, Locale locale) throws Exception {
		...
		if (viewName.startsWith(REDIRECT_URL_PREFIX)) {
			String redirectUrl = viewName.substring(REDIRECT_URL_PREFIX
					.length());
	...
	protected boolean canHandle(String viewName, Locale locale) {
		...
		return (viewNames == null || PatternMatchUtils.simpleMatch(viewNames,
				viewName));
	}
