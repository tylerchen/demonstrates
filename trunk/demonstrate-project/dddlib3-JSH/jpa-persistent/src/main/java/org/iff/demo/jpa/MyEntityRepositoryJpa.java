...
public class MyEntityRepositoryJpa implements EntityRepository {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(MyEntityRepositoryJpa.class);

	@Inject
	@PersistenceContext
	EntityManager entityManager;

	public MyEntityRepositoryJpa() {
	}
